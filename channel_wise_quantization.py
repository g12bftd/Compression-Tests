# -*- coding: utf-8 -*-
"""Channel-wise quantization.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1owXwIFPDkLOyvCO1vEe0ad0JRTnmHm0g
"""
...
"""Loading and Visualization of MNIST Data"""
...
"""Constructing ResNet18 Architecture"""
...
def train(args, model, device, train_loader, optimizer, epoch):
  ...
  @param args: arguments like log interval
  @param model: ResNet model to train
  @param device: CPU/GPU
  @param train_oader: dataset iterator
  @param optimizer: optimizer to update weights
  @param epcoh: number of epochs for training
  """
  model.train()
...
def print_size_of_model(model):
  ...
  @param model: the model whose size needs to be determined
  """
